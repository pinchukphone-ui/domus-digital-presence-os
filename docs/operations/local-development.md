...
E2E использует изолированные loopback-порты `4421`–`4423`, поэтому тесты можно запускать одновременно с Docker pilot на `4321`/`4322`; подключение к уже запущенному серверу запрещено.
